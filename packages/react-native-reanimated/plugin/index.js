...
var require_utils = __commonJS({
  "lib/utils.js"(exports2) {
    ...
    function isRelease() {
      ...
      return !!(process.env.BABEL_ENV?.match(pattern) || process.env.NODE_ENV?.match(pattern));
    }
...
var require_transform = __commonJS({
  "lib/transform.js"(exports2) {
    ...
    function workletTransformSync(code, opts) {
      ...
      return (0, core_1.transformSync)(code, {
        ...rest,
...
var require_workletFactory = __commonJS({
  "lib/workletFactory.js"(exports2) {
    ...
    function makeWorkletFactory(fun, state) {
      ...
      const pathForStringDefinitions = fun.parentPath.isProgram() ? fun : fun.findParent((path) => path.parentPath?.isProgram() ?? false);
      ...
      const workletHashProperty = (0, types_12.objectProperty)((0, types_12.stringLiteral)("hash"), (0, types_12.numericLiteral)(workletHash));
      const reanimatedWorkletCodeProperty = (0, types_12.objectProperty)((0, types_12.identifier)("__reanimated_workletCodeWrapper"), (0, types_12.objectExpression)([workletCodeProperty, workletHashProperty]));
      ...
      if (shouldInjectLocation) {
        ...
        if (state.opts.relativeSourceLocation) {
          ...
          sourceMapString = sourceMapString?.replace(state.file.opts.filename, location);
        }
  ...
  "lib/workletSubstitution.js"(exports2) {
    ...
    function substituteWorkletWithWorkletFactoryCall(path, workletFactoryCall) {
      if (path.isObjectMethod()) {
        ...
        const name = "id" in path.node ? path.node.id?.name : void 0;
